  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
            ...
            return (
              ...
              >
                <Link href={`/chat?topic=${topic.id}`}>
                  <div className="relative h-full p-6 rounded-2xl bg-card border border-border hover:border-gold/30 hover:shadow-lg dark:hover:shadow-gold/5 transition-all duration-300 overflow-hidden">
                    {/* Background Glow Effect - Dark mode */}
                    ...
                    <div className="relative z-10">
                      {/* Icon */}
                      <div className="w-14 h-14 rounded-xl bg-gold/10 border border-gold/20 flex items-center justify-center mb-5 group-hover:scale-110 transition-transform duration-300">
      ...
      <section className="px-4 sm:px-6 lg:px-8 pb-20">
        ...
        >
          <div className="relative p-8 md:p-12 rounded-2xl bg-card border border-border text-center overflow-hidden">
            {/* Background Elements */}
            <div className="absolute inset-0 opacity-30">
              <div className="absolute top-1/2 left-1/4 w-64 h-64 bg-gold/10 rounded-full blur-3xl" />
              <div className="absolute top-1/2 right-1/4 w-48 h-48 bg-gold/5 rounded-full blur-2xl" />
            </div>
            ...
            <div className="relative z-10">
              ...
              <Link href="/book-lawyer">
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="px-8 py-3.5 rounded-xl font-medium text-primary-foreground gold-shimmer"
                >
